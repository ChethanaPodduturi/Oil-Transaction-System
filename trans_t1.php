...
echo $_SESSION["Client_id"]=$clients;
...
$connection = mysqli_connect("localhost", "root", "India@1234"); // Establishing connection with server..
  ...
  $result1=mysqli_query($connection,"Select extract(month from Trans_date) as month, sum(oil_qty)  from transactions where Client_id='$_SESSION[Client_id]'
                                 and Status='PROCESSED' group by month");
...
<body>
<form class="form" method="post" action="trans_t2.php">
